...
function getConnection() {
    if (!isset($_SESSION['db_user']) || !isset($_SESSION['db_pass'])) {
        $koneksi = mysqli_connect("localhost", "root", "", "exodus2");
    } else {
        $username = $_SESSION['db_user'];
        $password = $_SESSION['db_pass'];
        $koneksi = mysqli_connect('localhost', $username, $password, 'exodus2');
    }
...
function getAllBarang()
{
    ...
    global $koneksi;
    $result = $koneksi->query("SELECT * FROM barang b, jenis j, distributor d WHERE b.id_jenis=j.id_jenis AND b.id_distributor=d.id_distributor");
